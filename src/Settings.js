    ...
    return (
        <div className="flex gap-1">
            {props.options.map((option) => (
                <button
                    className={
                        "border-2 border-gray-400 hover:bg-blue-300 transition-colors duration-300 rounded-lg py-1 px-2 " +
...
export default function Settings(props) {
    return (
        <div className="flex-shrink-0 bg-white rounded-3xl p-8 pt-6 flex flex-col gap-2">
